...
def _image_token_str(engine: OpenAIServing,
...
def _parse_chat_message_content_parts(
    ...
    if mm_futures:
        image_token_str = _image_token_str(engine, tokenizer)
...
def parse_chat_message_content(
    ...
    return _parse_chat_message_content_parts(engine, role, content, tokenizer)
